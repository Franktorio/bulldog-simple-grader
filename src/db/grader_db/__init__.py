...
from .students import Student, add_student, get_student, get_all_students, modify_student, delete_student, set_password, verify_password, change_password as change_student_password
...
from .instructors import Instructor, add_instructor, get_instructor, get_all_instructors, modify_instructor, delete_instructor, change_password as change_instructor_password
