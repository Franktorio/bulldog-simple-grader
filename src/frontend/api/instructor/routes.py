...
def instructor_login(request: Request, instructor_login_token: str = Cookie(None)):
    ...
    return templates.TemplateResponse(request=request, name=INSTRUCTOR_LOGIN_TEMPLATE, context={"user_data": user_data})
...
def instructor_home(request: Request, instructor: Instructor = Depends(get_authenticated_instructor)):
    ...
    return templates.TemplateResponse(request=request, name=INSTRUCTOR_HOME_TEMPLATE, context={"user_data": user_data})
...
def instructor_see_assignment(request: Request, assignment_id: int, instructor: Instructor = Depends(get_authenticated_instructor)):
    ...
    return templates.TemplateResponse(request=request, name=INSTRUCTOR_SEE_ASSIGNMENT_TEMPLATE, context={"user_data": user_data})
...
def instructor_see_submissions(request: Request, assignment_id: int, instructor: Instructor = Depends(get_authenticated_instructor)):
    ...
    return templates.TemplateResponse(request=request, name=INSTRUCTOR_SEE_SUBMISSIONS_TEMPLATE, context={"user_data": user_data})
...
def instructor_see_completions(request: Request, assignment_id: int, instructor: Instructor = Depends(get_authenticated_instructor)):
    ...
    return templates.TemplateResponse(request=request, name=INSTRUCTOR_SEE_COMPLETIONS_TEMPLATE, context={"user_data": user_data})
...
def instructor_add_assignment(request: Request, instructor: Instructor = Depends(get_authenticated_instructor)):
    ...
    return templates.TemplateResponse(request=request, name=INSTRUCTOR_ADD_ASSIGNMENT_TEMPLATE, context={"user_data": user_data})
...
def instructor_see_student(request: Request, student_id: int, instructor: Instructor = Depends(get_authenticated_instructor)):
    ...
    return templates.TemplateResponse(request=request, name=INSTRUCTOR_SEE_STUDENT_TEMPLATE, context={"user_data": user_data})
...
def instructor_see_student_submissions(request: Request, student_id: int, instructor: Instructor = Depends(get_authenticated_instructor)):
    ...
    return templates.TemplateResponse(request=request, name=INSTRUCTOR_SEE_STUDENT_SUBMISSIONS_TEMPLATE, context={"user_data": user_data})
...
def instructor_see_student_assignment_submissions(request: Request, student_id: int, assignment_id: int, instructor: Instructor = Depends(get_authenticated_instructor)):
    ...
    return templates.TemplateResponse(request=request, name=INSTRUCTOR_SEE_STUDENT_ASSIGNMENT_SUBMISSIONS_TEMPLATE, context={"user_data": user_data})
...
def instructor_add_student(request: Request, instructor: Instructor = Depends(get_authenticated_instructor)):
    ...
    return templates.TemplateResponse(request=request, name=INSTRUCTOR_ADD_STUDENT_TEMPLATE, context={"user_data": user_data})
